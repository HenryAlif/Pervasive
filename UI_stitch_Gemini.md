...
| **Warna Status** | • Beroperasi (Hijau): `#22C55E`<br>

<br>• Peringatan (Kuning): `#F59E0B`<br>

<br>• Gangguan (Merah): `#EF4444` | Buat sebagai *Color Style* di Figma |
| **Warna Netral** | Dark Theme: `#0F172A` (BG), `#1E293B` (Card)<br>

<br>Light Theme: `#F8FAFC` (BG), `#FFFFFF` (Card) | Pilih salah satu tema untuk seluruh layar |
...
* On Click $\rightarrow$ Navigate to.
